...
resource "digitalocean_project" "main" {
  name        = "marcin-zawiasa-github-actions-project"
...
resource "digitalocean_vpc" "main" {
  name     = "marcin-zawiasa-github-actions-vpc"
  region   = "fra1"
  ip_range = "10.111.10.0/24"
}
...
resource "digitalocean_ssh_key" "main" {
  name       = "marcin-zawiasa-github-actions-ssh-key"
  public_key = tls_private_key.main.public_key_openssh
}

resource "digitalocean_ssh_key" "own" {
  name       = "marcin-zawiasa-github-actions-own-ssh-key"
  public_key = var.own_ssh_public_key

}

resource "digitalocean_firewall" "main" {
  name        = "marcin-zawiasa-github-actions-firewall"
